      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              Frontend-focused developer with hands-on experience in building responsive, high-performance web applications using React, Next.js, JavaScript, and Tailwind CSS. Proficient in integrating machine learning models developed with Python, Pandas, NumPy, and Scikit-learn into real-world applications using Flask and FastAPI. Passionate about creating clean, user-centric interfaces and data-driven solutions.
            </p>
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            I am a third-year Computer Science undergraduate at MIT ADT University, Pune, with a strong interest in software development and machine learning. I have hands-on experience with Java, Python, React, FastAPI, and SQL, along with data analysis and ML tools such as NumPy, Pandas, and Scikit-learn. As a student, I am eager to learn, build real-world projects, and grow through practical experience and collaboration.
            </p>
