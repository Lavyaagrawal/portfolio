...
export default function Projects() {
  ...
  const projects = React.useMemo(
    () => [
      {
        title: "BYTE & BITE",
        link: "https://canteen-management-system-mocha.vercel.app",
        bgColor: "#0d4d3d",
        image: isMobile ? photo1 : img1, // Mobile vs desktop image
      },
      {
        title: "Diabetes prediction",
        link: "https://github.com/Lavyaagrawal/Diabetes-prediction-system",
        bgColor: "#3884d3",
        image: isMobile ? photo2 : img2,
      },
      {
        title: "EVENT INDIA",
        link: "https://github.com/Lavyaagrawal/Event-India",
        bgColor: "#dc9317",
