...
const socials = [
  ...
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/lavya-agrawal-026771287" },
  
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/Lavyaagrawal" },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Lavya Agrawal. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
